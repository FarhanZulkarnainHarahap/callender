...
const holidays = new Map([
  ["2026-01-01", { name: "Tahun Baru 2026 Masehi", type: "Libur Nasional" }],
  ["2026-01-16", { name: "Isra Mikraj Nabi Muhammad SAW", type: "Libur Nasional" }],
  ["2026-02-16", { name: "Cuti Bersama Tahun Baru Imlek 2577 Kongzili", type: "Cuti Bersama" }],
  ["2026-02-17", { name: "Tahun Baru Imlek 2577 Kongzili", type: "Libur Nasional" }],
  ["2026-03-18", { name: "Cuti Bersama Hari Suci Nyepi", type: "Cuti Bersama" }],
  ["2026-03-19", { name: "Hari Suci Nyepi Tahun Baru Saka 1948", type: "Libur Nasional" }],
  ["2026-03-20", { name: "Cuti Bersama Idul Fitri 1447 Hijriah", type: "Cuti Bersama" }],
  ["2026-03-21", { name: "Hari Raya Idul Fitri 1447 Hijriah", type: "Libur Nasional" }],
  ["2026-03-22", { name: "Hari Raya Idul Fitri 1447 Hijriah", type: "Libur Nasional" }],
  ["2026-03-23", { name: "Cuti Bersama Idul Fitri 1447 Hijriah", type: "Cuti Bersama" }],
  ["2026-03-24", { name: "Cuti Bersama Idul Fitri 1447 Hijriah", type: "Cuti Bersama" }],
  ["2026-04-03", { name: "Wafat Yesus Kristus", type: "Libur Nasional" }],
  ["2026-04-05", { name: "Kebangkitan Yesus Kristus (Paskah)", type: "Libur Nasional" }],
  ["2026-05-01", { name: "Hari Buruh Internasional", type: "Libur Nasional" }],
  ["2026-05-14", { name: "Kenaikan Yesus Kristus", type: "Libur Nasional" }],
  ["2026-05-15", { name: "Cuti Bersama Kenaikan Yesus Kristus", type: "Cuti Bersama" }],
  ["2026-05-27", { name: "Hari Raya Idul Adha 1447 Hijriah", type: "Libur Nasional" }],
  ["2026-05-28", { name: "Cuti Bersama Idul Adha 1447 Hijriah", type: "Cuti Bersama" }],
  ["2026-05-31", { name: "Hari Raya Waisak 2570 BE", type: "Libur Nasional" }],
  ["2026-06-01", { name: "Hari Lahir Pancasila", type: "Libur Nasional" }],
  ["2026-06-16", { name: "Tahun Baru Islam 1448 Hijriah", type: "Libur Nasional" }],
  ["2026-08-17", { name: "Proklamasi Kemerdekaan Republik Indonesia", type: "Libur Nasional" }],
  ["2026-08-25", { name: "Maulid Nabi Muhammad SAW", type: "Libur Nasional" }],
  ["2026-12-24", { name: "Cuti Bersama Hari Raya Natal", type: "Cuti Bersama" }],
  ["2026-12-25", { name: "Hari Raya Natal", type: "Libur Nasional" }]
]);
